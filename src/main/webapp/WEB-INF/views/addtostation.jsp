...
<html lang="en">
    ...
    <head>
        <title>Add To Station Page</title>
        <!-- Meta Tags -->
        ...
        <script>
            ...
            console.log(tostlist);
            angular.module('tostapp', []).controller('toStationController',
                    function ($scope) {
                        $scope.toStation = tostlist;
    ...
    <body ng-app="tostapp" ng-controller="toStationController">
        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    <li class="active">
                        <a href="welcome.jsp">
                            <i class="fas fa-th-large"></i> Add To Station </a>
                    </li>
                    <li>
            ...
            <div id="content">
                ...
                <section class="forms-section">
                    <form:form commandName="AddTostationObject" action="addingtostation"
                               enctype="multipart/form-data">
                        <h4 class="tittle-w3-agileits mb-4">Add To Station Table</h4>
                        <c:if test="${check}">
                            <div class="form-group" hidden="true">
                                <form:input class="form-control" Placeholder="Station Id"
                                            type="text" path="tostationid" required="true"></form:input>
                                </div>
                        </c:if>
                        <c:if test="${!check}">
                            <div class="form-group">
                                <form:input class="form-control" Placeholder="Station Id"
                                            type="text" path="tostationid" readonly="true" required="true"></form:input>
                                </div>
                        </c:if>
                        <div class="form-group">
                            <form:input class="form-control" Placeholder="From station name"
                                        type="text" path="tostname" required="true"></form:input>
                            </div>
                        <c:if test="${check}">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <tr  ng-repeat="tst in toStation">

                            <td>{{tst.tostationid}}</td>
                            <td>{{tst.tostname}}</td>
                            <td>
                                <a href="editaddtostationbutton?totationid={{tst.tostationid}}"><button id="editbuttons" 
                                                                                                        type="submit" class="btn btn-primary">Edit</button></a> 
                                <a  href="removingtotation/{{tst.tostationid}}"><button  id="removebuttons"
