...
INSERT INTO `feedback` (`feedid`,`passid`,`subject`,`detailsfeed`,`location`,`feddate`) VALUES 
 ...
 (12,1,'Vote','Dhaka','Dhaka','2019-01-08');
...
CREATE TABLE `launchinfo` (
  ...
  `launchsubid` int(11) default NULL,
...
INSERT INTO `launchinfo` (`launchid`,`fromstationid`,`tostationid`,`starttimeid`,`endtimeid`,`launchnumber`,`launchname`,`catid`,`dayoff`,`launchsubid`) VALUES 
 (1,1,2,1,8,'101','MV Tipu','6','2018-12-31',2),
 (2,1,3,1,5,'102','MV Farhan','7','2018-12-31',3),
 (3,1,1,1,1,'103','MV Parabat 11','6','2018-12-31',1),
 (4,2,2,1,1,'104','MV Kalam Khan','6','Friday',3),
 (5,1,2,2,1,'105','MV Coco','6','Saturday',1),
 (6,1,5,1,8,'106','MV Tipu 7','7','Friday',4);
...
INSERT INTO `passengerinfo` (`passid`,`passaddress`,`passage`,`passgender`,`passgmail`,`passname`,`passstatus`,`fromstationid`,`tostationid`,`starttimeid`,`endtimeid`,`ticketpurdate`,`tickettakendate`) VALUES 
 ...
 (3,'Dhaka',25,'Male','dipu@test.com','Dipu','Non-Govt',1,1,1,3,'2019-01-10','2019-01-12'),
 (4,'Bhola',26,'Male','tuhin@test.com','Md. Tuhin','Non-Govt',2,2,1,1,'2019-01-10','2019-01-10'),
 (5,'Savar',30,'Male','sakib@test.com','Sakib Rasel','Non-Govt',4,6,2,3,'2019-01-10','2019-01-10'),
 (6,'Mirpu',30,'Female','Rezana@test.com','Rezana Sarkar','01724263832',1,1,1,1,'2019-01-10','2019-01-10'),
 (7,'Teskuni para',28,'Female','ruman@test.com','Remana Yesmin','01922950948',1,5,1,4,'2019-01-10','2019-01-03'),
 (8,'Malibag',32,'Male','kabir@test.com','Sarkar Kabir Uddin','01917513794',1,1,6,5,'2019-01-10','2019-01-19');
...
INSERT INTO `reservation` (`reservid`,`emailid`,`launchid`,`fromstationid`,`tostationid`,`starttimeid`,`endtimeid`,`launchname`,`launchnumber`,`ptn`,`resstatus`,`passid`,`resdate`,`catid`,`qty`,`describtion`,`launchsubid`) VALUES 
 (1,'noman@gmail.com',1,1,1,3,2,'MV Parabat 11','103',164823,'Ordered',1,'2012-12-29',NULL,NULL,'',NULL),
 (2,'sarkar@gail.com',3,1,1,4,2,'MV Tipu','102',664335,'Ordered',2,'2012-12-31',NULL,NULL,'',NULL),
 (3,'noman@test.com',3,1,1,1,6,'MV Parabat 11','103',34061,'order',1,'2019/01/08',NULL,NULL,'',NULL),
 (4,'noman@test.com',3,1,1,1,6,'MV Parabat 11','103',12824,'order',2,'2019/01/08',NULL,NULL,'',NULL),
 (5,'noman@test.com',3,1,1,1,6,'MV Parabat 11','103',68502,'order',1,'2019/01/08',NULL,NULL,'',NULL),
 (6,'noman@test.com',3,1,1,1,6,'MV Parabat 11','103',35892,'order',2,'2019/01/08',NULL,NULL,'',NULL),
 (7,'noman@test.com',3,1,1,1,6,'MV Parabat 11','103',17199,'order',1,'2019/01/08',NULL,NULL,'',NULL),
 (8,'noman@test.com',3,1,1,1,6,'MV Parabat 11','103',79741,'order',1,'2019/01/08',NULL,NULL,'',NULL),
 (9,'noman@test.com',3,1,1,1,6,'MV Parabat 11','103',54707,'order',2,'2019/01/08',NULL,NULL,'',NULL),
 (10,'noman@test.com',3,1,1,1,6,'MV Parabat 11','103',78620,'order',2,'2019/01/08',NULL,NULL,'',NULL),
 (11,'noman@test.com',3,1,1,1,6,'MV Parabat 11','103',83044,'order',1,'2019/01/08',NULL,NULL,'',NULL),
 (12,'noman@test.com',3,1,1,1,6,'MV Parabat 11','103',64036,'order',1,'2019/01/08','6',2,NULL,NULL),
 (13,'noman@test.com',3,1,1,1,6,'MV Parabat 11','103',23823,'order',1,'2019/01/08','6',2,'Revier Side',NULL),
 (14,'noman@test.com',3,1,1,1,6,'MV Parabat 11','103',15338,'order',2,'2019/01/09','6',2,'Revier Side',NULL),
 (15,'123',3,1,1,1,6,'MV Parabat 11','103',17497,'order',2,'2019/01/11','6',2,'Revier Side',NULL),
 (16,'',5,1,2,2,6,'MV Coco','105',53377,'order',2,'2019/01/12','6',2,'Revier Side',NULL);
